...
#define    DISABLE_ESC_INT()           NVIC_DisableIRQ(EXTI3_IRQn)		// {(_INT1IE)=0;} /**< \brief Disable interrupt source INT1*/
#endif
#ifndef ENABLE_ESC_INT
#define    ENABLE_ESC_INT()           NVIC_EnableIRQ(EXTI3_IRQn)			// {(_INT1IE)=1;} /**< \brief Enable interrupt source INT1*/
#endif
